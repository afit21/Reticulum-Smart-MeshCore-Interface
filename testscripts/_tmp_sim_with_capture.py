...
def main() -> None:
    ...
    try:
        for name in end_node_names:
            ...
            cfg_kwargs["packet_capture_enabled"] = True
            cfg_kwargs["packet_capture_dir"] = "/tmp/claude-1000/-home-afi-Documents-Reticulum-Smart-MeshCore-Interface-Reticulum-Smart-MeshCore-Interface/2149869b-037f-4a26-a998-0bd6e48c12a6/scratchpad/capture_test"
            if args.debug:
